...
export function RailwayHero() {
  return (
    <section className="relative pt-24 sm:pt-28 pb-16 bg-[#0d1117] text-white border-b border-[#30363d]">
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        <p className="text-lg sm:text-2xl font-bold text-[#58a6ff] tracking-tight mb-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#1f6feb] hover:bg-[#388bfd] text-white font-bold text-sm active:scale-95 transition-all shadow-md"
          >
